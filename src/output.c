...
void output_rule_data(void)
{
    ...
    if (svflag)                 /*rwj */
        fprintf(output_file, "\tstatic shortint yylhs[] = { %0d,", symbol_value[start_symbol]);
    else
    ...
    if (svflag)                 /*rwj */
        fprintf(output_file, "\tstatic shortint yylen[] = { %0d,", 2);
    else
...
void output_yydefred(void)
{
    ...
    if (svflag)
        fprintf(output_file, "\tstatic shortint yydefred[] = { %0d,", (defred[0] ? defred[0] - 2 : 0));
    else
...
void goto_actions(void)
{
    ...
    if (svflag)                 /*rwj */
        fprintf(output_file, "\tstatic shortint yydgoto[] = { %0d,", k);
    else
...
void output_base(void)
{
    ...
    if (svflag)                 /*rwj */
        fprintf(output_file, "\tstatic shortint yysindex[] = { %0d,", base[0]);
    else
    ...
    if (svflag)                 /*rwj */
        fprintf(output_file, " 0 \n\t};\n\tstatic shortint yyrindex[] = { %0d,", base[nstates]);
    else
    ...
    if (!rflag)
        outline += 2;
    if (svflag)                 /*rwj */
        fprintf(output_file, "0 \n\t};\n\tstatic shortint yygindex[] = { %0d,", base[2 * nstates]);
    else
...
void output_table(void)
{
    ...
    if (svflag) {               /*rwj */
        ...
        fprintf(output_file, "\tshortint yytable[] = { %0d,", table[0]);
    } else {
        fprintf(code_file, "`define YYTABLESIZE %d\n", high);
...
void output_check(void)
{
    ...
    if (svflag)                 /*rwj */
        fprintf(output_file, "\tshortint yycheck[] = { %0d,", check[0]);
    else
...
void output_stype(void)
{
    ...
    if (svflag) {               /*rwj */
		...
		strcmp(svsemantic_type, "real") == 0) {
            ...
            fprintf(f, " */\n");
            fprintf(f, "  function new(); // %s\n", sv_valclass);
            fprintf(f, "\n");
            fprintf(f, "  endfunction \n");
            fprintf(f, "/**\n");
            fprintf(f, " * Initialize me as an int\n");
            fprintf(f, " */\n");
            fprintf(f, "  function set_i(int val); // %s\n", sv_valclass);
            fprintf(f, "    ival=val;\n");
            fprintf(f, "  endfunction\n");
            fprintf(f, "\n");
            fprintf(f, "/**\n");
            ...
            fprintf(f, " */\n");
            fprintf(f, "  function set_d(real val); // %s\n", sv_valclass);
            fprintf(f, "    dval=val;\n");
            fprintf(f, "  endfunction\n");
            fprintf(f, "\n");
            fprintf(f, "/**\n");
            ...
            fprintf(f, " */\n");
            fprintf(f, "  function set_s(string val); // %s\n", sv_valclass);
            fprintf(f, "    sval=val;\n");
            fprintf(f, "  endfunction\n");
            fprintf(f, "\n");
            fprintf(f, "/**\n");
            ...
            fprintf(f, " */\n");
            fprintf(f, "  //function set_obj(Object val); // %s\n", sv_valclass);
            fprintf(f, "  //  obj=val;\n");
            fprintf(f, "  //endfunction\n");
            fprintf(f, "endclass\n\n");
            fclose(f);
            ...
            fprintf(code_file, "\n");
            fprintf(code_file, "\tfunction void val_init();\n");
            fprintf(code_file, "\t  valstk = new[YYSTACKSIZE]; // %s\n", sv_valclass);
            fprintf(code_file, "\t  yyval=new (); // %s\n", sv_valclass);
            fprintf(code_file, "\t  yylval=new (); // %s\n", sv_valclass);
